function out = fig_serology_meta_outside_asia(mcRecSerologyMetaPrctile, seroprevDataMeta, dataSerologyMetaMean, dataSerologyMetaCI)
...
sgtitle('RSV Seroprevalence outside Asia by age, country and year', 'FontSize', 10, 'FontWeight', 'bold');
AddLetters2Plots(fig_handle, {'e', 'f', 'g'})
