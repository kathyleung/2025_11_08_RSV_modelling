...
for kkStrategy = 1:6
    ...
    temp2Reshp = reshape(temp2_1+temp2_2,1,numRnd);
    ...
    temp4Reshp = reshape(temp4,length(totalPopulation),numRnd);
...
percReductionPrc = mean(prctile(percReduction,[50,2.5,97.5],3),1);
for kkStrategy = 1:6
    % 0-11 months
...
% Plot
% fig_reduction_by_age_group(yearlyAvgReportOutcomePerc8);
