...
static emlrtRSInfo emlrtRSI = {
    ...
    "G:\\My Drive\\MATLAB\\m. RSV modelling\\48. RSV simulation only with mAb "
    "and vaccination Thailand\\age_SEIR_RSV_intervention.m" /* pathName */
};
...
static emlrtRSInfo i_emlrtRSI = {
    ...
    "G:\\My Drive\\MATLAB\\m. RSV modelling\\48. RSV simulation only with mAb "
    "and vaccination Thailand\\calcAgingRate.m" /* pathName */
};
...
static emlrtBCInfo emlrtBCI = {
    ...
    "G:\\My Drive\\MATLAB\\m. RSV modelling\\48. RSV simulation only with mAb "
    "and vaccination Thailand\\age_SEIR_RSV_intervention.m", /* pName */
    3                                                        /* checkKind */
};
...
static emlrtDCInfo emlrtDCI = {
    ...
    "calcAgingRate", /* fName */
    "G:\\My Drive\\MATLAB\\m. RSV modelling\\48. RSV simulation only with mAb "
    "and vaccination Thailand\\calcAgingRate.m", /* pName */
    1                                            /* checkKind */
};
    ...
    struct1_T *out)
{
  ...
  ndbl = populationSizeTable->data[1].f1[12] * 12.0;
  ...
  sumInfections = populationSizeTable->data[1].f1[13] * 12.0;
  ...
  q = populationSizeTable->data[1].f1[14] * 12.0;
  ...
  dailyMortalityByAge[24] =
      ((populationSizeTable->data[3].f1[12] * out->Rt->data[(int32_T)ndbl - 1] +
        populationSizeTable->data[3].f1[13] *
            out->Rt->data[(int32_T)sumInfections - 1]) +
       populationSizeTable->data[3].f1[14] * out->Rt->data[(int32_T)q - 1]) /
      b_sumColumnB(&populationSizeTable->data[3].f1[12]) / 365.25 * 12.0;
  /*  Rate of vaccination */
  for (ii = 0; ii <= 22; ii += 2) {
    _mm_storeu_pd(
