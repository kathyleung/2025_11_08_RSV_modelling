...
for(iiText in textVec){
  ...
  # descriptives
  print(mean(iiDataTable$num_diary_contact))
  print(sd(iiDataTable$num_diary_contact))
  print(std.error(iiDataTable$num_diary_contact))
  # gender
  print(with(iiDataTable, tapply(num_diary_contact, gender, mean)))
  print(with(iiDataTable, tapply(num_diary_contact, gender, sd)))
  print(with(iiDataTable, tapply(num_diary_contact, gender, std.error)))
  # age
  print(with(iiDataTable, tapply(num_diary_contact, age_or_mid_range, mean)))
  print(with(iiDataTable, tapply(num_diary_contact, age_or_mid_range, sd)))
  print(with(iiDataTable, tapply(num_diary_contact, age_or_mid_range, std.error)))
  # weekday
  print(with(iiDataTable, tapply(num_diary_contact, actual_week_day, mean)))
  print(with(iiDataTable, tapply(num_diary_contact, actual_week_day, sd)))
  print(with(iiDataTable, tapply(num_diary_contact, actual_week_day, std.error)))
  # household size
  iiDataTable$num_usual_contacts[iiDataTable$num_usual_contacts>5] = 5;
  print(with(iiDataTable, tapply(num_diary_contact, num_usual_contacts, mean)))
  print(with(iiDataTable, tapply(num_diary_contact, num_usual_contacts, sd)))
  print(with(iiDataTable, tapply(num_diary_contact, num_usual_contacts, std.error)))
  # edu
  print(with(iiDataTable, tapply(num_diary_contact, edu, mean)))
  print(with(iiDataTable, tapply(num_diary_contact, edu, sd)))
  print(with(iiDataTable, tapply(num_diary_contact, edu, std.error)))
  # income
  print(with(iiDataTable, tapply(num_diary_contact, income_mid_range, mean)))
  print(with(iiDataTable, tapply(num_diary_contact, income_mid_range, sd)))
  print(with(iiDataTable, tapply(num_diary_contact, income_mid_range, std.error)))
