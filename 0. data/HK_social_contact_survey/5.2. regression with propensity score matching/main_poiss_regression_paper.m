...
% descriptive
for iiEduIdx = 1:3
    display([length(regrTable.num_diary_contact(regrTable.edu==iiEduIdx & regrTable.mode_survey==1)),...
        mean(regrTable.num_diary_contact(regrTable.edu==iiEduIdx & regrTable.mode_survey==1)),...
        std(regrTable.num_diary_contact(regrTable.edu==iiEduIdx & regrTable.mode_survey==1))]);
end
...
% descriptive
for iiIncomeIdx = 1:5
    display([length(regrTable.num_diary_contact(regrTable.income_mid_range==iiIncomeIdx & regrTable.mode_survey==1)),...
        mean(regrTable.num_diary_contact(regrTable.income_mid_range==iiIncomeIdx & regrTable.mode_survey==1)),...
        std(regrTable.num_diary_contact(regrTable.income_mid_range==iiIncomeIdx & regrTable.mode_survey==1))]);
end
