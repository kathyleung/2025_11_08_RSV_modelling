...
write.csv(matchDataTab,'regrTab_matchedPS.csv',row.names = FALSE);
...
# i.e. the effect of choice of paper/online questionnaire on the number of reported contacts
# Matched samples
matchedNB = glm.nb(num_diary_contact~gender+age_or_mid_range+actual_week_day+num_usual_contacts+edu+income_mid_range+mode_survey,
                   data = matchDataTab,
