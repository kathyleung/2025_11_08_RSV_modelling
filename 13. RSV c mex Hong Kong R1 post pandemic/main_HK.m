...
% PHSM
relTransmissionPHSM = [...
    1.57E+00	4.41E-01	2.02E-01	2.84E-02	6.34,...
    1.57E+00	4.41E-01	2.02E-01	2.84E-02	6.34,...
    1.57E+00	4.41E-01	2.02E-01	2.84E-02	6.34,...
    1.57E+00	4.41E-01	2.02E-01	2.84E-02	6.34,...
    1.57E+00	4.41E-01	2.02E-01	2.84E-02	6.34,...
...
seroprevDataHK.date_collection = days(datetime(seroprevDataHK.SampleCollectionDate,'Format','uuuu-MM-dd')-dateZero);
...
mcResPrev = readtable('../1. RSV c mex Hong Kong R1 rev block update logL component rev/mcmc_result/hongkong_mcmc_res.csv');
mcResPrev = mcResPrev{mcResPrev{:,1}~=0,:};
mcResPrev = mcResPrev((length(mcResPrev(:,1))*0.2):end,:);
mcResPrevPosterior = mean(mcResPrev);

x0 = relTransmissionPHSM;
