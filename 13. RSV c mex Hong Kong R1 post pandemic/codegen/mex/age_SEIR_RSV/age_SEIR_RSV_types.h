...
#ifndef typedef_b_age_SEIR_RSV_api
#define typedef_b_age_SEIR_RSV_api
typedef struct {
  struct1_T out;
} b_age_SEIR_RSV_api;
#endif /* typedef_b_age_SEIR_RSV_api */

#ifndef typedef_age_SEIR_RSVStackData
#define typedef_age_SEIR_RSVStackData
typedef struct {
  b_age_SEIR_RSV_api f0;
} age_SEIR_RSVStackData;
#endif /* typedef_age_SEIR_RSVStackData */

/* End of code generation (age_SEIR_RSV_types.h) */
