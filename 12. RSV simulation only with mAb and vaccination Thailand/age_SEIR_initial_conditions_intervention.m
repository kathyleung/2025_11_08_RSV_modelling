...
for iiAge = 1:numAgeGroups
    ...
    stateM(1,iiAge) = Na * pa_xi * (1-mAbCoverage(iiAge)-mVaxCoverage(iiAge));
    stateVmab1(1,iiAge) = Na * pa_xi * mAbCoverage(iiAge)/2;
    stateVmab2(1,iiAge) = Na * pa_xi * mAbCoverage(iiAge)/2;
    stateVmvax1(1,iiAge) = Na * pa_xi * mVaxCoverage(iiAge)/2;
    stateVmvax2(1,iiAge) = Na * pa_xi * mVaxCoverage(iiAge)/2;
    stateVpvax1(1,iiAge) = Na * pa_xi * oVaxCoverage(iiAge)/2;
    stateVpvax2(1,iiAge) = Na * pa_xi * oVaxCoverage(iiAge)/2;
