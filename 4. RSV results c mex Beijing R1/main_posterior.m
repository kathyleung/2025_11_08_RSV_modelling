...
% mcmcRes = readmatrix('../5. RSV c mex Beijing R1 block update logL component no sero/mcmc_result/China_subnational_Beijing_mcmc_res.csv');
mcmcRes = readmatrix('../6. RSV c mex Beijing R1 block update logL component region sero/mcmc_result/China_subnational_Beijing_mcmc_res.csv');
