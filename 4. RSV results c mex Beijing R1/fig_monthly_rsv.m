function out = fig_monthly_rsv(mcRecMonthlyPrctile, monthlyILICaseRSV, dateZero,cutoffCOVID)
    ...
    plot(monthMidPoints, smooth(monthlyILICaseRSV.num_monthly_RSV_pos,1), '-', 'Color', [0.8500, 0.3250, 0.0980], 'LineWidth', 1);
    ...
    for i = 1:size(year_positions, 1)
        ...
        text(mid_pos, -max(monthlyILICaseRSV.num_monthly_RSV_pos)*0.18, num2str(year_val), ... 
