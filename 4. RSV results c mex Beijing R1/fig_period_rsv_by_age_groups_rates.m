function [out,rec] = fig_period_rsv_by_age_groups_rates(mcRecMonthlyByAgePrctile, periodCaseRSV,populationAgeGroup, dateZero, cutoffCOVID)
    ...
    for ageGroup = 1:6
        ...
        yearly_mean_model_median = yearly_mean_model_median/populationAgeGroupMean(ageGroup)*100000;
        yearly_mean_model_lowerCI = yearly_mean_model_lowerCI/populationAgeGroupMean(ageGroup)*100000;
        yearly_mean_model_upperCI = yearly_mean_model_upperCI/populationAgeGroupMean(ageGroup)*100000;
        yearly_mean_observed = yearly_mean_observed/populationAgeGroupMean(ageGroup)*100000;

        % Combine data for grouped bar chart (Observed first, then Model)
        groupedBarData = [yearly_mean_observed, yearly_mean_model_median];
        rec(:,:,ageGroup) = [yearly_mean_model_median,yearly_mean_model_lowerCI,yearly_mean_model_upperCI];
