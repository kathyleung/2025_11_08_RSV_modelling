...
% mcmcRes = readmatrix('../8. RSV c mex Thailand R1 block update logL component no sero/mcmc_result/thailand_mcmc_res.csv');
% mcmcRes = readmatrix('../9. RSV c mex Thailand R1 block update logL component region sero/mcmc_result/thailand_mcmc_res.csv');
