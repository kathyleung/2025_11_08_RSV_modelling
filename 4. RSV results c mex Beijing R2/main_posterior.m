...
paramLabels = {...
    ...
    '\alpha','q_p','b_1','\phi','\psi','I_1(0)','I_2(0)',...
    '\epsilon_\lambda','\epsilon_c','\epsilon_2_-_4','\epsilon_5_-_1_4',...
    '\epsilon_1_5_-_5_4','\epsilon_5_5_-_7_4','\epsilon_\geq_7_5','\pi','\partial'};
...
histogram(mcmcRes(:,1).*mcmcRes(:,2),30,'Normalization','pdf',...
    'FaceColor',posteriorColor,'EdgeColor',posteriorColor,...
    'FaceAlpha',0.35);
title([paramLabels{1},' \times ',paramLabels{2}],...
    'Interpreter','tex')
box off
